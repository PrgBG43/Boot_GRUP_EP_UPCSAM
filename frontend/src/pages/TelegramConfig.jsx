...
const MESSAGE_FIELDS = [
  ...
  {
    key: 'cancel_start_message',
    label: 'Inicio de cancelación',
    placeholder: 'Voy a ayudarte a cancelar una cita.',
  },
  {
    key: 'cancel_no_appointments_message',
    label: 'Sin citas para cancelar',
    placeholder: 'No encontré citas activas para cancelar. Si necesitas ayuda, comunícate directamente con el negocio.',
  },
  {
    key: 'cancel_select_message',
    label: 'Selección de cita para cancelar',
    placeholder: 'Encontré varias citas activas. Selecciona cuál deseas cancelar.',
  },
  {
    key: 'cancel_confirm_message',
    label: 'Confirmación de cancelación',
    placeholder: '¿Confirmas que deseas cancelar la cita de {service_name} del {date} a las {time}?',
  },
  {
    key: 'cancel_success_message',
    label: 'Cancelación exitosa',
    placeholder: 'Tu cita fue cancelada correctamente.',
  },
  {
    key: 'cancel_rejected_message',
    label: 'Cancelación rechazada',
    placeholder: 'Perfecto, tu cita se mantiene activa.',
  },
  {
    key: 'cancellation_disabled_message',
    label: 'Cancelación deshabilitada',
    placeholder: 'Este negocio no tiene habilitada la cancelación por Telegram. Comunícate directamente con el establecimiento para recibir ayuda.',
  },
  {
    key: 'goodbye_message',
...
function toForm(config) {
  return {
    ...
    cancel_start_message: config?.cancel_start_message || '',
    cancel_no_appointments_message: config?.cancel_no_appointments_message || '',
    cancel_select_message: config?.cancel_select_message || '',
    cancel_confirm_message: config?.cancel_confirm_message || '',
    cancel_success_message: config?.cancel_success_message || '',
    cancel_rejected_message: config?.cancel_rejected_message || '',
    cancellation_disabled_message: config?.cancellation_disabled_message || '',
